...
fun HistoryScreen(navController: NavController, chatbotViewModel: ChatbotViewModel) {
    // Force a refresh of sessions when this screen is shown
    LaunchedEffect(Unit) {
        // This will ensure we always get the latest sessions for the current user
        chatbotViewModel.loadSavedSessions()
    }
    ...
    Column(
        ...
        Row(
            ...
            Text("History", fontSize = 32.sp, color = Color.White, fontWeight = FontWeight.ExtraBold)
        }
